...
_salvageVehicle_REQUIRE_TOOL_DIFFERENT	= false;

// Set the clasname of the tools required to salvage all vehicles
_salvageVehicle_TOOLS					= ["Exile_Item_Grinder"];
...
_salvageVehicle_REQUIRE_TOOLS_CAR		= ["Exile_Item_Grinder","Exile_Item_Foolbox"];
...
_salvageVehicle_REQUIRE_TOOLS_TANK		= ["Exile_Item_Grinder","Exile_Item_Foolbox","Exile_Item_Wrench"];
...
_salvageVehicle_REQUIRE_TOOLS_AIR		= ["Exile_Item_Grinder","Exile_Item_Foolbox","Exile_Item_Wrench"];
...
_givenJunkCar							= [["Exile_Item_JunkMetal", 1],["Exile_Item_MetalPole", 1],["Exile_Item_MetalBoard", 1]];

// Set the Junk returned to the player for salvaging a Tank only.
_givenJunkTank							= [["Exile_Item_JunkMetal", 1],["Exile_Item_MetalPole", 1],["Exile_Item_MetalBoard", 1]];

// Set the Junk returned to the player for salvaging an Aircraft only.
_givenJunkAir							= [["Exile_Item_JunkMetal", 1],["Exile_Item_MetalPole", 1],["Exile_Item_MetalBoard", 1]];

// Set the Junk returned to the player for salvaging a Boat only.
_givenJunkShip							= [["Exile_Item_JunkMetal", 1],["Exile_Item_MetalPole", 1],["Exile_Item_MetalBoard", 1]];